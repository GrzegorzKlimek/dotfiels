...
alias run-lolhub="mvn spring-boot:run -Dspring-boot.run.profiles=dev,frontend -Dfrontend"
...
alias run-lolhub-full="cd $HOME_DIR/Documents/$REPOS_DIR/eclipse-workspaces/spotik-ws/lolhub && mvn spring-boot:run -Dspring-boot.run.profiles=dev"
