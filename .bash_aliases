...
alias run-se="mvn spring-boot:run -Dspring-boot.run.profiles=devlocal,devlol"
alias debug-se="mvn spring-boot:run -Dspring-boot.run.profiles=devlocal,devlol -Dspring-boot.run.jvmArguments='-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=8000'"
alias test-se="mvn test -Dtest=LolScrapperTest -Dspring-boot.run.profiles=devlocal,devlol"
